...
/**
* @param[in] timIndex: Timer Index
*
* @return TIMx: Current Timer Type
*
* @brief Get Timer Control Type
*/
...
/**
* @param[in] TIMx: Timer type point
* @param[in] timConfig: TIMER config type point
* @return 0:Success
*
...
int32_t TIMER_Init(TIMER_Type *TIMx, TIMER_ConfigType *timConfig)
{
    ...
    for (i = 0; i < TIMER_NUM; i++)
    {
        ...
        {
            timeIrq = (IRQn_Type)s_timerIrqnCtrlMap[i];
        }
    }
...
/**
* @param[in] TIMx: Timer type point
* @param[in] loadValue: Load Value for TIMER register
* @return none
*
* @brief Set TIMER Load Value Register
*/
...
* @return none
*
* @brief clear TIMER channel timer interrrupt flag
*/
