...
/**
* @param[in] acmpChannel: ACMP channel  select
...
/**
* @param[in] acmpChannel: ACMP channel  select
* @param[in] hystValue: ACMP  Hysteresis  value 0: low hysteresis; 1: high hysteresis
* @return none
*
...
/**
* @param[in] acmpChannel: ACMP channel  select
* @param[in] edgeSelect:  falling or rising selction
* @return none
*
...
* @return 0 : not support, other: output value
*
