...
* WDOG_Initialize
*
* @param[in]  config: WDOG configuration structure pointer
...
* @return 0: success, other: error value
*
* @brief  Uninitialize WDOG module
*/
...
*
* @param[in] callback: WDOG Event Callback
* @return 0: success, other: error value
*
* @brief  set WDOG event callback function
*/
int32_t WDOG_SetEventCallback(WDOG_EventCallback callback)
{
    uint8_t  index = ((uint32_t)WDOG0 - (uint32_t)WDOG0) >> 12;
