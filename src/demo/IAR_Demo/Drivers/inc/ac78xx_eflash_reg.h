...
typedef struct {
    ...
    __IO uint32_t REG_EFLASH_CTRL3;         ///< Control register 3,                      offset: 0x40
...
#define EFLSH_CTRL2_CLK_CHG_BSY_POS     17                                               ///< EFLSH_CTRL2: CLK_CHG_BSY Position
#define EFLSH_CTRL2_CLK_CHG_BSY_MSK     (0x03UL << EFLSH_CTRL2_CLK_CHG_BSY_POS)          ///< EFLSH_CTRL2: CLK_CHG_BSY Mask

// EFLSH_CTRL3
#define EFLSH_CTRL3_PVD_WARNING_POS     31                                               ///< EFLSH_CTRL3: pvd warning Position
#define EFLSH_CTRL3_PVD_WARNING_MSK     (0x01UL << EFLSH_CTRL3_PVD_WARNING_POS)           ///< EFLSH_CTRL3: pvd warning Mask
...
{
    return ((EFLASH->REG_EFLASH_CTRL3 & EFLSH_CTRL3_PVD_WARNING_MSK) >> EFLSH_CTRL3_PVD_WARNING_POS);
}
