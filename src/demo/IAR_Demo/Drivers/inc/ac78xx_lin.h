...
typedef struct
{
    uint32_t mode : 2;             ///< LIN mode
    uint32_t autoWakeup : 1;       ///< Auto wakeup mode
    uint32_t breakThreshold : 1;   ///< Break threshold for slave
    uint32_t autoResync : 1;       ///< Automatic resynchronization
    uint32_t softCtrl : 1;         ///< Software control mode
