...
* @param[in] sampleCounter: Division factor for bus clock
* @return    none
*
...
*
* @param[in] UARTx: UART type pointer
* @param[in] uartSetting: Setting type pointer
* @return    always 0
*
...
*
* @param[in] UARTx: UART type pointer
* @param[in] Callback: UART Callback
...
*
* @param[in] uartIndex: UART index
* @param[in] dataBits: Transfer bits select
* @param[in] memStartAddr: Memory start address
* @param[in] txTransferNum: Transfer numbers
* @param[in] callback: DMA callback function
* @return    0:Success,  -1:Fail
*
...
*
* @param[in] uartIndex: UART index
* @param[in] dataBits: Receive bits select
* @param[in] memStartAddr: Memory start address
* @param[in] rxTransferNum: Receive numbers
* @param[in] callback: DMA callback Function
* @return    0:Success,  -1:Fail
*
