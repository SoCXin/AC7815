...
#define            MULCOM_IDLE             (1<<0)
#define            MULCOM_IDLEIE           (1<<4)
#define            MULCOM_RWUCRT           (1<<5)
#define            MULCOM_WAKESEL          (1<<6)
...
typedef volatile struct {
    ...
    struct {                                                       ///< [offset:0x58]UARTn_MULCOMCR, Multiprocessor communication control register
        ...
        uint32_t    RWUCRT            :1;                          ///< bit[5]:Receiver wake up control
        uint32_t    WAKESEL           :1;                          ///< bit[6]:Wake up method select
...
__STATIC_INLINE void UART_SetDivisor(UART_Type *UARTx, float div)
{
    ...
    uint32_t fracDiv = (div - integerDiv) * 32;
...
*
* @param[in] UARTx: UART type pointer
* @param[in] sampleCounter: UART Sample counter
* @return    none
*
...
*
* @param[in] UARTx: UART type pointer
* @param[in] guardTime: UART GuardTime
* @return    none
*
...
*
* @param[in] UARTx: UART type pointer
* @param[in] slaveAddr: UART slave address
* @return    none
*
...
*
* @param[in] UARTx: UART type pointer
* @param[in] mulCom: UART MulCom
* @return    none
*
* @brief  Set UART multiprocessor communication
*/
__STATIC_INLINE void UART_SetMulCom(UART_Type *UARTx, uint8_t mulCom)
{
    UARTx->UARTn_MULCOMCR.MULCOMEN = ((mulCom>>7) & 0x1);
    UARTx->UARTn_MULCOMCR.WAKESEL  = ((mulCom>>6) & 0x1);
    UARTx->UARTn_MULCOMCR.RWUCRT   = ((mulCom>>5) & 0x1);
    UARTx->UARTn_MULCOMCR.IDLEIE   = ((mulCom>>4) & 0x1);
}
...
*
* @param[in] UARTx: UART type pointer
* @param[in] mulComEn: UART MulComEn
* @return    none
*
...
*
* @param[in] UARTx: UART type pointer
* @param[in] wakeSel: UART wakeSel
* @return    none
*
* @brief  Set UART wake up method select
*/
__STATIC_INLINE void UART_SetWakeSel(UART_Type *UARTx, uint8_t wakeSel)
{
    if (wakeSel == 1)
    {
        UARTx->UARTn_MULCOMCR.WAKESEL = 1;
    }
    else
    {
        UARTx->UARTn_MULCOMCR.WAKESEL = 0;
    }
}
...
*
* @param[in] UARTx: UART type pointer
* @param[in] wakeupCtrl: UART Wakeup Control
* @return    none
*
* @brief  Set UART receiver wake up control
*/
__STATIC_INLINE void UART_SetWakeupCtrl(UART_Type *UARTx, uint8_t wakeupCtrl)
{
    if (wakeupCtrl == 1)
    {
        UARTx->UARTn_MULCOMCR.RWUCRT = 1;
    }
    else
    {
        UARTx->UARTn_MULCOMCR.RWUCRT = 0;
    }
}
...
*
* @param[in] UARTx: UART type pointer
* @param[in] idleEn: UART IdleEn
* @return    none
*
* @brief  Set UART idle interrupt enable
*/
...
*
* @param[in] UARTx: UART type pointer
* @param[in] scratch: UART scratch
* @return    none
*
* @brief  Set UART scratch
*/
__STATIC_INLINE void UART_SetSCR(UART_Type *UARTx, uint8_t scratch)
{
    UARTx->UARTn_SCR = scratch;
}
