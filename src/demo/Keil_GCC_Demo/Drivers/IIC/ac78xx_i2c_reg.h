...
#ifndef _AC78XX_I2C_REG_H_
#define _AC78XX_I2C_REG_H_
#ifdef __cplusplus
extern "C" {
#endif
...
* @return none
*
* @brief  Write reg to send I2C start signal
*/
...
* @return none
*
* @brief  Write reg to send I2C stop signal
*/
...
*
* @brief  check current busy status
*/
...
*
* @brief  check current internal HW status
*/
...
*
* @brief  check current internal I2C master or not
*/
...
*
* @brief  check whether I2C hardware detected STOP or not
*/
...
*
* @brief  check whether I2C hardware detected start or not
*/
...
*
* @brief  check current I2C status_1
*/
...
*
* @brief  check current I2C status_2
*/
...
* @return none
*
* @brief  clear current I2C status_1
*/
...
* @return none
*
* @brief  clear current I2C status_2
*/
...
*
* @brief  check whether i2c dma rx is enable
*/
...
* @return none
*
* @brief  Reset I2C by software reset
*/
