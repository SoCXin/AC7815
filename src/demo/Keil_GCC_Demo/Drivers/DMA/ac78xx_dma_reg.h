 ...
 *
 * @param[in] DMAx:DMA type pointer
 * @param[in] memIncrement:DMA Memory increment
 * @return    none
 *
 ...
 *
 * @param[in] DMAx:DMA type pointer
 * @param[in] periphIncrement:DMA Periph increment
 * @return    none
 *
 ...
 *
 * @param[in] DMAx:DMA type pointer
 * @param[in] channelCircular:DMA channel circular
 * @return    none
 *
 ...
 *
 * @param[in] DMAx:DMA type pointer
 * @param[in] channelDir:DMA channel direction
 * @return    none
 *
 ...
 *
 * @param[in] DMAx:DMA type pointer
 * @param[in] memByteMode:DMA channel mem byte mode
 * @return    none
 *
 ...
 *
 * @param[in] DMAx:DMA type pointer
 * @param[in] memStartAddr:DMA memory start address
 * @return    none
 *
 ...
 *
 * @param[in] DMAx:DMA type pointer
 * @param[in] memEndAddr:DMA memory end address
 * @return    none
 *
 ...
 *
 * @param[in] DMAx:DMA type pointer
 * @param[in] periphAddr:DMA peripheral address
 * @return    none
 *
