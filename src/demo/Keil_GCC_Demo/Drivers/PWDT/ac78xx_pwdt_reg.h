...
/**
*
* @param[in] pinNum: (PWDT_PINSEL_PIN0 to PWDT_PINSEL_PIN3)
*
* @return none
*
* @brief set PWDT module input pin selct.
*
*/
...
/**
*
* @param[in] edgeMode: (FALLING_START_CAPTURE_FALLING to RISING_START_CAPTURE_RISING)
*
* @return none
*
...
/**
*
* @param[in] clockSource: PWDT_PCLKS_BUS and PWDT_PCLKS_ALTCLK
*
* @return none
*
...
/**
*
* @param[in] pinSel: Set PWDT Input PIN(PWDT_PINSEL_PIN0 to PWDT_PINSEL_PIN3)
*
* @return none
*
